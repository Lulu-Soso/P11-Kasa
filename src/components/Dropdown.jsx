              ...
              <div className="dropdown-about">
                ...
                {isOpenReliability && shouldShowReliability &&
                    <div className="dropdown-content">
                      <p>La annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux
                ...
                {isOpenRespect && shouldShowRespect &&
                    <div className="dropdown-content">
                      <p>La bienveillance fait partie des valeurs fondatrices de Kasa. Tout comportement discriminatoire
                        ou de perturbation du voisinage entrainera une exclusion de notre plateforme.</p>
                    </div>}
              </div>
          )}
